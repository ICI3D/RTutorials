...
## disease in Daidd County in 2007, and the Department of Health has enlisted your help
## to understand the data they have collected since that time.
##
## In 2006 and 2007 the outbreaks looked pretty similar. First, let's look at how the epidemics
## in dogs and people progressed in 2007:

par(mar=c(5,5,2,1),mfrow=c(2,2)) # Set up plot
plot.cases(data.2007)            # Plot epidemic curve for 2007

## The x-axis is time (week of the year), and the y-axis is the number of new cases observed.
## Overall, there were 759 canine cases and 786 human cases over a period of 16 weeks. In 2008,
...
## In 2009, there was only one case in dogs and one in humans, but in 2010, another large
...
## Based on the data from 2007-2010, what have you learned about DF?  What factors might determine the
...
##
## A veterinary vaccine against DF had been approved for use in dogs in mid-2009, but since there was
## not a problem that year, the Health Department did not promote it's use. Following the the disease's
## resurgence in 2010, however, information on the vaccine was sent to veterinarians and pet owners
## in an effort to encourage vaccine uptake. By the beginning of 2011, 40 percent of the dog population
## in Daidd County had been vaccinated.
##
## In 2011, the number of DF cases was substantially lower than in any year other than 2009, with only 34
...
## the disease as well. Other employees pointed out that there were more cases in 2011 than in 2009 (before
...
## outbreaks). This group concluded that the relatively small number of cases in 2011 could be unrelated to
...
## gotten sick in 2011, and by the beginning of 2012, 50 percent of the dog population in Daidd County had
## been vaccinated.
##
## As it turned out, the 2012 data did not clarify things for the Director, and the debate within the department
## only grew more heated, with each side claiming that the 2012 data supported their argument:

plot.cases(data.2012)            # Plot epidemic curve for 2012

## In the first 17 weeks of 2012, 109 dogs and 213 people contracted DF. 
## 
...
##
## Luckily for the Director of the Health Department, the approval of a human vaccine against DF in mid-2012
...
## By the beginning of 2013, 50 percent of the people in Daidd County had been vaccinated, though dog vaccine
## uptake fell to 20 percent.
##
## Although the 2013 season got off to a slow start, the Director was in for a surprise when the outbreak
## picked up later in the season. In the end, the 2013 outbreak was the worst one for years, with 480 canine
...
## time for the 2014 season as possible. By the beginning of the year, 80 percent of the people in Daidd County
...
## see so many canine cases in Daidd County in 2014:

plot.cases(data.2014)            # Plot epidemic curve for 2014

## In fact, there were more cases of DF in dogs in 2014 than in any year on record, with 812 canine cases,
...
## of the observed data? What would you advise the AD to do in order to prepare for the 2015 DF season? 
##
## PART 4 - Moving forward
##
## Decide on target levels of vaccination for dogs and people in 2015, keeping in mind that it is unlikely that
...
target.2015 <- run.example(VaxPct.Dogs,VaxPct.Humans)

## Plot the cases through time to see what happened:

plot.cases(target.2015)
